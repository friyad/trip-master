        ...
        <div className="rounded-lg bg-gray-100 shadow-md" data-aos="fade-up"
            ...
            <div className="p-2">
                ...
                <div className="flex justify-between py-3 px-2 items-center">
                    <h3 className="text-xl text-gray-800 font-semibold">${price}</h3>
                    <Link to={`/tourDetails/${_id}`} className="px-4 py-2 rounded-md defaultBtn inline-block">
                        Show Details</Link>
                </div>
            </div>
        </div>
